...
import P2.turtle.TurtleGUI;
import P2.turtle.Action.ActionType;

/**
 * Turtle for drawing in a window on the screen.
 */
public class DrawableTurtle implements P2.turtle.Turtle {
    ...
    private final List<P2.turtle.LineSegment> lines;

    private Point currentPosition;
    private double currentHeading;
    private P2.turtle.PenColor currentColor;
    ...
    public void forward(int steps) {
        ...
        P2.turtle.LineSegment lineSeg = new P2.turtle.LineSegment(currentPosition.x(), currentPosition.y(), newX, newY, currentColor);
    ...
    public void color(P2.turtle.PenColor color) {
